...
class SceneDescription():
    ...
    def set_active_lane(self, memory):
        if len(self.boundaries.bottom) == 1:
            ...
            self.active_lane_from_memory(self.boundaries.bottom, memory)

    def active_lane_from_memory(self, memory):
        m100 = [m.boundaries.get_active_lane() for m in memory[-60:-10]]
    ...
    def get_small_image(self, w, h):
        ...
        self.w, self.h = w, h
        self.w1, self.w2 = int(mid - w / 2), int(mid + w / 2)
